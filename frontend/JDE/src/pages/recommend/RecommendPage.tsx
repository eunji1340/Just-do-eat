...
const ITEMS: Restaurant[] = [
  {
    ...
    image: ['https://picsum.photos/id/1018/1200/800', 'https://picsum.photos/id/1015/1200/800'],
    category: '한식',
    rating: 4.5,
    price_range: 'MEDIUM',
    website_url: 'https://place.map.kakao.com/m/12345678',
    menu: [{ name: '불고기', price: 15000 }, { name: '비빔밥', price: 12000 }, { name: '된장찌개', price: 9000 }],
    distance_m: 500,
    is_open: true,
  },
  {
    ...
    image: ['https://picsum.photos/id/1025/1200/800', 'https://picsum.photos/id/1020/1200/800'],
    category: '치킨',
    rating: 4.6,
    price_range: 'MEDIUM',
    website_url: 'https://place.map.kakao.com/m/45678901',
    menu: [{ name: '후라이드 치킨', price: 17000 }, { name: '양념치킨', price: 18000 }, { name: '간장치킨', price: 19000 }],
    distance_m: 300,
    is_open: true,
  },
  // 필요 시 더 추가
